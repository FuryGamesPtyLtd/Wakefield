...
//
//
template<typename Arg0> void Print(Arg0&& arg0);
template<typename Arg0, typename... Args> void Print(Arg0&& arg0, Args&&... args);
...
//
#define WKF_PRINT_EXPR(expr) do { Print(#expr, "=", expr); } while (0)
